...
create type public.contact_type as enum ('Direct', 'Partner');
create type public.opportunity_type as enum ('Sell', 'Rent Out');
...
create type public.currency_code as enum ('LKR', 'USD');
create type public.social_platform as enum ('Ikman', 'LPW', 'Facebook', 'Instagram');
